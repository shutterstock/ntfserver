...
exports.createServer = function() {
  ...
  app.configure(setting.env.dev, function() {
    ...
    swig.setDefaults({ root: setting.project.template_path, allowErrors: true })
  })

  app.configure(setting.env.prod, function() {
    app.use(express.errorHandler())
    shared.io.set('log level', 1)
    swig.setDefaults({ root: setting.project.template_path, allowErrors: false, cache: 'memory' })
  })
