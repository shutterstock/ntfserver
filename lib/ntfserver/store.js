...
var handleAssertion = exports.handleAssertion = function(test_result_id, assertion) {
  work = []
...
var handleSuite = exports.handleSuite = function(suite) {
  async.auto({
    // agent
