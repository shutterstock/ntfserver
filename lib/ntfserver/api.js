...
exports.suiteList = function(obj, cb) {
  if (arguments.length == 1) { cb = obj; obj = {} }
  if (typeof(cb) !== 'function') throw new Error('callback required')
  if (typeof(obj) !== 'object') return cb(new Error('first argument must be an object'))
  // number
...
exports.suiteResultList = function(obj, cb) {
  ...
  if (obj.limit > 1000) obj.limit = 1000
  // suite result id
  if (obj.hasOwnProperty('suite_result_id') &&
      typeof(obj.suite_result_id) !== 'number') {
