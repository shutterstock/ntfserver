...
TestResult.getOrInsert = function(obj, cb) {
  ...
  if (typeof(obj.agent_id) !== 'number') return cb(new Error('invalid agent_id: ' + obj.agent_id))
  if (typeof(obj.test_id) !== 'number') return cb(new Error('invalid test_id: ' + obj.test_id))
  if (typeof(obj.duration) !== 'number') return cb(new Error('invalid duration: ' + obj.duration))
  if (typeof(obj.passes) !== 'number') return cb(new Error('invalid passes: ' + obj.passes))
  if (typeof(obj.failures) !== 'number') return cb(new Error('invalid failures: ' + obj.failures))
  if (typeof(obj.time) !== 'number') return cb(new Error('invalid time: ' + obj.time))
