...
AssertionResult.getOrInsert = function(obj, cb) {
  ...
  if (typeof(obj.stack) !== 'string')
    return cb(AssertionResult.error('invalid stack type: ' + obj.stack))

  global.sql.query(
    'INSERT INTO assertion_result (test_result_id, assertion_id, ok, stack)' +
    '  VALUES (?, ?, ?, ?)' +
    '  ON DUPLICATE KEY UPDATE assertion_result_id = last_insert_id(assertion_result_id)',
    [obj.test_result_id, obj.assertion_id, (obj.ok ? 1 : 0), obj.stack],
  function(err, info) {
